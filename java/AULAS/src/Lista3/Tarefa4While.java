...
psicológicas dos indivíduos de uma região. Para tanto, a cada uma das pessoas era perguntado: idade,
	...
	public static void main(String[] args) {
		...
		//variaveis
				...
				while (contador<PESSOAS) {
					...
					idade = leia.nextInt();
					System.out.print("Digite o sexo (1-feminino / 2-masculino / 3-Outros) pessoa "+contador+": ");
					sexo = leia.next().charAt(0);
					System.out.println("Digite a opção: ");
					System.out.print("1 pessoa calma\n2 pessoa nervosa\n3 pessoa agressiva pessoa "+contador+": ");
