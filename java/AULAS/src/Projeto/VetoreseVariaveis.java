...
public class VetoreseVariaveis {
	public static void main(String[] args) {
		...
		//vetores
		String nomeProduto[]= {"Tênis Nike", "Tênis Adidas", "Tênis Puma", "Camisa Nike","Camisa Lacoste", "Camisa Supreme", "Meia Nike", "Meia Adidas", "Bola de futebol", "Blusa moleton Nike"};
		...
		for (int y=0; y<10; y++) {
		 ...
		 for (int x=0; x<10; ++x) {
			 if (codigoEscolhido == codigoProduto[x]) {
				 ...
				 if(qtaAdicionadoCarrinho[x] <= estoqueProduto[x] && carrinho[x]==" " && qtaAdicionadoCarrinho[x] >0) {
