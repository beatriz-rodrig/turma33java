...
{
/*
 1- Elaborar um programa que efetue a leitura sucessiva de valores numéricos e apresente no final o 
 ...
 */
	...
	funcao inicio()
	{
		real somatorio=0.0, media, total=0.0, numero=0.0
		enquanto (numero>=0){
		...
		escreva ("\nA somatoria de numeros digitados é de:" , somatorio)
